...
const handler = async (event, context) => {
  ...
  const server = tracer.trace(
    'apollo.create_server',
    () =>
      new ApolloServer({
  ...
  const handler = tracer.trace('apollo.create_handler', () =>
